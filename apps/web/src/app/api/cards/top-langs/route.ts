...
import { renderTopLanguagesCard } from "@/lib/cards/renderTopLanguages";
import {
  parseCacheSeconds,
  parseTopLangsOptions,
  renderErrorCard,
  svgHeaders,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const svg = renderTopLanguagesCard(data.languages, parseTopLangsOptions(searchParams));
